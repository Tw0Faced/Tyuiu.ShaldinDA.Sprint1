...
//Задание:
//Написать программу, которая запрашивает у пользователя исходные данные, вычисляет результат по формуле (x*Pi)/(2*a) и печатает его на экране.

namespace Tyuiu.ShaldinDA.Sprint1.Task1.V23
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Тема: Базовые навыки рыботы в C#                                        *");
